...
class ArtistEditor < ArtistDBClass
    ...
    def initialize(rartist)
        super()

        @glade = GTBld::load(DLG_DB_EDITOR) #DLG_ART_EDITOR)
        init_baseui("arted_")
...
class RecordEditor < RecordDBClass
    ...
    def initialize(rrecord)
        super()

        @glade = GTBld::load(DLG_REC_EDITOR)
        init_baseui("reced_")
...
class SegmentEditor < SegmentDBClass
    ...
    def initialize(rsegment)
        super()

        @glade = GTBld::load(DLG_SEG_EDITOR)
        init_baseui("seged_")
...
class TrackEditor < TrackDBClass
    ...
    def initialize(rtrack)
        super()

        @glade = GTBld::load(DLG_TRK_EDITOR)
        init_baseui("trked_")
